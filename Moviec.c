...
Movie movies[MAX_MOVIES] = {
    {"The Action Hero",       "10:00 AM", "An action-packed thriller.",      50,  320.0, 4,  16.0},
    {"Love in Paris",         "01:00 PM", "A heartwarming romantic comedy.", 40,  240.0, 4,  15.0},
    {"The Drama Queen",       "03:00 PM", "A gripping drama.",               30,  210.0, 4,  17.0},
    {"Adventure Island",      "06:00 PM", "An exciting adventure.",          20,  480.0, 4,  19.0},
    {"Haunted Nights",        "09:00 PM", "A chilling horror movie.",        10,  150.0, 4,  13.0},
    {"Sci-Fi Odyssey",        "11:00 AM", "A journey through space.",        50,  330.0, 4,  13.0},
    {"Mystery Manor",         "02:00 PM", "A suspenseful mystery.",          30,  135.0, 4,  18.0},
    {"Fantasy World",         "05:00 PM", "A magical fantasy adventure.",    40,  230.0, 4,  16.0},
    {"Crime Story",           "08:00 PM", "A thrilling crime drama.",        25,  410.0, 4,  14.0},
    {"Comedy Tonight",        "10:00 PM", "A hilarious comedy show.",        35,  185.0, 4,  17.0},
    {"The Last Samurai",      "11:00 AM", "An epic historical drama.",       20,  280.0, 4,  12.0},
    {"Romantic Getaway",      "01:00 PM", "A romantic journey.",             30,  190.0, 4,  15.0},
    {"Documentary: Nature",   "03:00 PM", "A documentary about nature.",     15,  140.0, 4,  16.0},
    {"Horror Night",          "06:00 PM", "A night of horror stories.",      25,  180.0, 4,  17.0},
    {"Sci-Fi Legends",        "09:00 PM", "Legends of sci-fi.",              35,  330.0, 4,  14.0},
    {"Historical Events",     "10:00 AM", "A look at historical events.",    20,  110.0, 4,  13.0},
    {"Action Heroes",         "12:00 PM", "Stories of action heroes.",       40,  163.0, 4,  18.0},
    {"Romantic Tales",        "03:00 PM", "Romantic tales from history.",    25,  214.0, 4,  11.0},
    {"Comedy Stars",          "06:00 PM", "A look at comedy stars.",         30,  265.0, 4,  13.0},
    {"Thriller Night",        "09:00 PM", "A night of thrilling stories.",   35,  155.0, 4,  17.0},
    {"Fantasy Adventures",    "11:00 AM", "Fantasy adventure stories.",      20,  180.0, 4,  15.0},
    {"Crime Fighters",        "02:00 PM", "Stories of crime fighters.",      25,  135.0, 4,  14.0},
    {"Documentary: Space",    "05:00 PM", "A documentary about space.",      15,  190.0, 4,  16.0},
    {"Horror Legends",        "08:00 PM", "Legends of horror.",              25,  180.0, 4,  17.0},
    {"Sci-Fi Explorers",      "10:00 PM", "Explorers of sci-fi.",            35,  330.0, 4,  12.0},
    {"Historical Journeys",   "10:00 AM", "Journeys through history.",       20,  110.0, 4,  10.0},
    {"Action Packed",         "12:00 PM", "A pack of action movies.",        40,  163.0, 4,  16.0},
    {"Romantic Classics",     "03:00 PM", "Classic romantic movies.",        25,  214.0, 4,  14.0},
    {"Comedy Legends",        "06:00 PM", "Legends of comedy.",              30,  265.0, 4,  15.0},
    {"Thriller Movies",       "09:00 PM", "A selection of thriller movies.", 35,  155.0, 4,  19.0},
    {"Fantasy World 2",       "11:00 AM", "More fantasy adventures.",        20,  180.0, 4,  11.0},
    {"Crime Thrillers",       "02:00 PM", "Thrilling crime stories.",        25,  135.0, 4,  13.0},
    {"Documentary: Oceans",   "05:00 PM", "A documentary about oceans.",     15,  290.0, 4,  16.0},
    {"Horror Classics",       "08:00 PM", "Classic horror stories.",         25,  180.0, 4,  15.0},
    {"Sci-Fi Futures",        "10:00 PM", "The future of sci-fi.",           35,  130.0, 4,  14.0},
    {"Historical Drama",      "10:00 AM", "Dramatic historical events.",     20,  110.0, 4,  13.0},
    {"Action Thrills",        "12:00 PM", "Thrilling action movies.",        40,  163.0, 4,  14.0},
    {"Romantic Stories",      "03:00 PM", "Romantic stories to watch.",      25,  214.0, 4,  12.0},
    {"Comedy Nights",         "06:00 PM", "Comedy movies for the night.",    30,  265.0, 4,  13.0},
    {"Thriller Classics",     "09:00 PM", "Classic thriller movies.",        35,  155.0, 4,  11.0},
    {"Fantasy World 3",       "11:00 AM", "Even more fantasy adventures.",   20,  180.0, 4,  10.0},
    {"Crime Stories",         "02:00 PM", "True crime stories.",             25,  135.0, 4,  14.0},
    {"Documentary: Wildlife", "05:00 PM", "A documentary about wildlife.",   15,  190.0, 4,  15.0},
    {"Horror Nights",         "08:00 PM", "Horror stories for the night.",   25,  180.0, 4,  16.0},
    {"Sci-Fi Stories",        "10:00 PM", "Stories from the world of sci-fi",35,  130.0, 4,  18.0},
    {"Historical Films",      "10:00 AM", "Historical films to watch.",      20,  110.0, 4,  15.0},
    {"Action Classics",       "12:00 PM", "Classic action movies.",          40,  163.0, 4,  17.0},
    {"Romantic Movies",       "03:00 PM", "Romantic movies to enjoy.",       25,  214.0, 4,  17.0},
    {"Comedy Movies",         "06:00 PM", "Comedy movies for everyone.",     30,  265.0, 4,  15.0},
    {"Thriller Stories",      "09:00 PM", "Stories of thrill and suspense.", 35,  155.0, 4,  18.0},
    {"Fantasy Films",         "11:00 AM", "Fantasy films to enjoy.",         20,  180.0, 4,  15.0},
    {"Crime Films",           "02:00 PM", "Films about crime.",              25,  135.0, 4,  16.0},
    {"Documentary: Earth",    "05:00 PM", "A documentary about Earth.",      15,  190.0, 4,  17.0},
    {"Horror Films",          "08:00 PM", "Horror films to watch.",          25,  180.0, 4,  15.0},
    {"Sci-Fi Films",          "10:00 PM", "Sci-fi films to enjoy.",          35,  130.0, 4,  17.0}
};
